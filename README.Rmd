...
Things get a bit more complicated when you need **rules and their corresponding URLs** (the lowest level of aggregation). This level requires digging through the code on the chapter-level and then visiting each rule separately so it is **much slower** than the previous method. 
